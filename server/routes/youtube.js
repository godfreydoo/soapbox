...
router.post('/video', (req, res) => {
  try {
    ...
    const videos = axios.get(`https://www.googleapis.com/youtube/v3/search?&maxResults=8&key=${process.env.GOOGLE_API}&channelId=${req.body.channelId}&part=id&order=date`).then(data => {
